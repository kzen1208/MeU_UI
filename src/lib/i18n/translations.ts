...
export const translations = {
  vi: {
    ...
    hero: {
      ...
      exploreCta: "Khám phá Components",
    },
    logos: {
    ...
    componentsDirectory: {
      sidebar: {
        ...
        allComponents: "Tất cả Components",
        stable: "Ổn định",
        planned: "Dự kiến",
        templates: "Templates",
      ...
      mobileSearchPlaceholder: "Tìm kiếm components",
      headerTitle: "Components",
      emptyState: "Không có component phù hợp với tìm kiếm này.",
      viewAll: "Xem tất cả",
      modal: {
        open: "Mở",
        copy: "Copy",
        copied: "Đã copy",
        description: (category: string, status: string) =>
          `Component ${category} trong MeU UI Hub, trạng thái ${status}. Dùng nút copy để lấy prompt, code hoặc code kèm demo cho component này.`,
        copyActions: {
          prompt: {
            label: "Copy prompt",
            description: "Prompt sẵn sàng cho AI với đầy đủ context của component.",
          },
          code: {
            label: "Copy code",
            description: "Mã nguồn gốc của component.",
          },
          codeDemo: {
            label: "Copy code + demo",
            description: "Mã nguồn component kèm cách dùng demo.",
          },
        },
        ariaLabels: {
          toggleTheme: "Đổi giao diện",
          refreshPreview: "Tải lại preview",
          copyLink: "Copy liên kết",
          saveComponent: "Lưu component",
          openExternally: "Mở ở trang ngoài",
          closeDialog: "Đóng",
          changeCopyAction: "Đổi loại copy",
        },
      },
    },
    templatesPage: {
      ...
      title: "Templates",
      description: "Bộ sưu tập template giao diện sẵn dùng cho landing page, dashboard, admin panel và nhiều hơn nữa.",
      searchPlaceholder: "Tìm kiếm template",
      allTemplates: "Tất cả Templates",
      groups: {
        marketing: "Marketing",
        applications: "Applications",
      },
      free: "Free",
      templateCount: (count: number) => `${count} template hiển thị`,
      emptyState: "Không có template phù hợp với bộ lọc hiện tại.",
      clearFilters: "Xoá bộ lọc",
    },
    storyFlow: {
      sections: [
    ...
    auth: {
      ...
      profile: {
        ...
        adminDashboardLink: "Trang quản trị",
        adminDashboardDescription: "Quản lý components và templates hiển thị trên Hub.",
      },
    },
    adminDashboard: {
      title: "Trang quản trị",
      subtitle: "Quản lý components và templates hiển thị trên MeU UI Hub.",
      backHome: "Về trang chủ",
      accessDenied: {
        title: "Không có quyền truy cập",
        description: "Bạn cần đăng nhập với tài khoản quản trị viên để xem trang này.",
        backHome: "Về trang chủ",
      },
      stats: {
        categories: "Danh mục component",
        components: "Components",
        templates: "Templates",
        custom: "Mục tự thêm",
        users: "Người dùng",
      ...
      distribution: {
        componentsTitle: "Components theo danh mục",
        templatesTitle: "Templates theo danh mục",
        unitComponents: "components",
        unitTemplates: "templates",
        deltaLabel: "so với mục kế",
        periodAll: "Tất cả",
        periodTop5: "Top 5",
      },
      tabs: {
      ...
      users: {
        ...
        subtitle: "Xem danh sách và phân quyền người dùng trên Hub.",
        table: {
          name: "Tên",
          email: "Email",
          role: "Vai trò",
      ...
      custom: {
        title: "Mục tự thêm",
        subtitle: "Components và templates do quản trị viên thêm vào Hub.",
      },
      removed: {
        title: "Mục đã ẩn",
        subtitle: "Components và templates đã bị ẩn khỏi Hub, có thể khôi phục lại.",
        emptyComponents: "Không có component nào bị ẩn.",
        emptyTemplates: "Không có template nào bị ẩn.",
      },
      actions: {
        add: "Thêm mới",
        edit: "Sửa",
      ...
      fields: {
        ...
        category: "Danh mục",
        status: "Trạng thái",
        previewKind: "Kiểu preview",
        accent: "Màu nhấn",
        link: "Liên kết",
        price: "Giá (USD, để trống = miễn phí)",
        linkPlaceholder: "https://...",
      },
      components: {
        title: "Quản lý Components",
        addTitle: "Thêm component mới",
        editTitle: "Sửa component",
        table: {
          name: "Tên",
          category: "Danh mục",
          status: "Trạng thái",
        ...
        empty: "Chưa có component nào.",
      },
      templates: {
        title: "Quản lý Templates",
        addTitle: "Thêm template mới",
        editTitle: "Sửa template",
        table: {
          name: "Tên",
          category: "Danh mục",
          price: "Giá",
  ...
  en: {
    ...
    componentsDirectory: {
      ...
      mobileSearchPlaceholder: "Search components",
      headerTitle: "Components",
      emptyState: "No components match this search.",
      viewAll: "View all",
      modal: {
        open: "Open",
        copy: "Copy",
        copied: "Copied",
        description: (category: string, status: string) =>
          `${category} component in MeU UI Hub, status ${status}. Use the copy button to grab a prompt, code, or code with demo for this component.`,
        copyActions: {
          prompt: {
            label: "Copy prompt",
            description: "AI-ready prompt with full component context.",
          },
          code: {
            label: "Copy code",
            description: "Raw source code of the component.",
          },
          codeDemo: {
            label: "Copy code + demo",
            description: "Component source together with its demo usage.",
          },
        },
        ariaLabels: {
          ...
          changeCopyAction: "Change copy action",
        },
      },
    },
    templatesPage: {
      ...
      breadcrumbTemplates: "Templates",
      title: "Templates",
      description: "A collection of ready-to-use UI templates for landing pages, dashboards, admin panels, and more.",
      ...
      free: "Free",
      templateCount: (count: number) => `${count} template${count === 1 ? "" : "s"} shown`,
      emptyState: "No templates match the current filters.",
      clearFilters: "Clear filters",
    },
    storyFlow: {
      sections: [
    ...
    auth: {
      ...
      profile: {
        ...
        adminDashboardDescription: "Manage the components and templates shown on the Hub.",
      },
    },
    adminDashboard: {
      title: "Admin dashboard",
      subtitle: "Manage the components and templates shown on MeU UI Hub.",
      backHome: "Back to home",
      accessDenied: {
        title: "Access denied",
      ...
      distribution: {
        ...
        templatesTitle: "Templates by category",
        unitComponents: "components",
        unitTemplates: "templates",
        deltaLabel: "vs next category",
        periodAll: "All",
        periodTop5: "Top 5",
      },
      tabs: {
      ...
      users: {
        ...
        subtitle: "View and manage user roles across the Hub.",
        table: {
          name: "Name",
          email: "Email",
          role: "Role",
      ...
      custom: {
        title: "Custom items",
        subtitle: "Components and templates added by admins to the Hub.",
      },
      removed: {
        title: "Removed items",
        subtitle: "Components and templates hidden from the Hub. You can restore them.",
        emptyComponents: "No components are hidden.",
        emptyTemplates: "No templates are hidden.",
      },
      actions: {
        add: "Add new",
        edit: "Edit",
      ...
      fields: {
        ...
        accent: "Accent color",
        link: "Link",
        price: "Price (USD, leave empty for free)",
        linkPlaceholder: "https://...",
      },
      components: {
        title: "Manage components",
        addTitle: "Add a new component",
