...
export default function TrainingStack() {
  ...
  return (
    <section id="training" className="bg-stone-50">
      <div className="container mx-auto min-h-svh place-content-center px-6 text-stone-900 xl:px-12">
        <div className="grid md:grid-cols-2 md:gap-8 xl:gap-12">
          <div className="md:sticky md:top-0 md:flex md:h-screen md:flex-col md:justify-center md:py-16">
            <h5 className="text-xs uppercase tracking-wide">{t.eyebrow}</h5>
            <h2 className="mb-6 mt-4 text-4xl font-bold tracking-tight">
              {t.headingPrefix}{" "}
              <span className="text-indigo-500">{t.headingHighlight}</span>{" "}
              {t.headingSuffix}
            </h2>
            <p className="max-w-prose text-sm">{t.description}</p>
          </div>
